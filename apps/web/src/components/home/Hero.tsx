...
export default function Hero() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center bg-neutral-950 px-4 pt-20 max-sm:pt-32 max-sm:pb-20 text-center text-white overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        {/* Yellow underline */}
        <div className="mx-auto mb-6 h-1 w-20 bg-gradient-to-r from-yellow-600 to-orange-600"></div>
      ...
      {/* Down arrow */}
      <div className=" animate-bounce text-yellow-600 absolute bottom-2">
        <ChevronDown size={32} />
      </div>
    </section>
  );
